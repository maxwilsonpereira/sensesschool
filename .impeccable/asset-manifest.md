...
| `src/assets/design/education-pattern.png` | 1920 x 614 RGBA illustrated background pattern downloaded from `https://sensesschool.com.br/wp-content/themes/senses-theme/img/fundo-educa.png`. It is retained as PNG because it has alpha transparency and is already only 62 KB; recompression would not provide a meaningful delivery benefit. | Reserved for the homepage manifesto section beginning “Nosso trabalho é abrir horizontes...”. It must remain a non-essential decorative background, with any later parallax movement fully disabled for reduced-motion users. |
